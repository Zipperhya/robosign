...
class get_model(nn.Module):
    def __init__(self,num_class,normal_channel=False):
        ...
        self.sa2 = PointNetSetAbstraction(npoint=16, radius=0.4, nsample=8, in_channel=128 + 3, mlp=[128, 128, 256], group_all=False)
    ...
    def forward(self, xyz):
        ...
        B, frame, number,_ = xyz.shape
        xyz = xyz.reshape(B, frame * number, 3)
